...
| 元素 | 文件 | 渲染说明 |
|---|---|---|
| 面板背景/标题栏/底栏/侧边栏/分割线/输入框 | `panel_bg.png` 等 | 拉伸，v2.2.4 起 |
| 右键菜单/弹窗/私聊横条/设置背景/内容区 | `context_menu_bg.png` 等 | 拉伸，v2.2.4-2.2.5 |
...
**示例**：`E33Chat-Texture-Demo` 资源包（测试服版本目录 resourcepacks/ 内）演示时间分隔符与 toast 的覆盖效果；进游戏「选项 → 资源包 → 可用」启用，F3+T 热重载，无需重启。
