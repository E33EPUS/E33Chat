...
public final class PanelBackground {
    ...
    private static final ResourceLocation ID = new ResourceLocation("e33chat", "panel_bg_custom");
    ...
    public static void draw(net.minecraft.client.gui.GuiGraphics g,
        ...
        int[] src = sourceRect(texW, texH, w, h, parseCrop(ChatBubbleConfig.PANEL_BG_CROP.get()));
