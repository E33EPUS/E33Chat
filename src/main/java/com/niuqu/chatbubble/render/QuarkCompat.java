...
public final class QuarkCompat {
    ...
    public static void init(int screenW, int screenH) {
        ...
        if (emoteMap == null || emoteMap.isEmpty()) return;
    ...
    public static void render(GuiGraphics g, Font font, int mouseX, int mouseY,
        ...
        if (!isLoaded() || buttons == null || buttons.isEmpty()) return;
    ...
    public static boolean handleClick(double mouseX, double mouseY) {
        if (!isLoaded() || buttons == null) return false;
    ...
    private static void sendEmote(String regName) {
        try {
            ...
            // Try NeoForge networking, fall back to Zeta/ZetaNetwork
            try {
                ...
                try {
                    ...
                    // Reflection fallback: try Zeta's SimpleChannel via Forge
                    try {
