...
public final class UiPrimitives {
    ...
    public static void fillRounded(DrawContext g, int x1, int y1, int x2, int y2, int radius, int color) {
        RoundRectRenderer.fill(g, x1, y1, x2, y2, radius, color);
    }

    public static void strokeRounded(DrawContext g, int x1, int y1, int x2, int y2, int radius, int width, int color) {
        int w = x2 - x1, h = y2 - y1;
    ...
    public static void withRoundedClip(DrawContext g, int x1, int y1, int x2, int y2, int radius, Runnable draw) {
        int w = x2 - x1, h = y2 - y1;
    ...
    private static void drawClippedBand(DrawContext g, int left, int top, int right, int bottom, Runnable draw) {
