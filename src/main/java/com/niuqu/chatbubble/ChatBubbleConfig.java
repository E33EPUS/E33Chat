...
public class ChatBubbleConfig {
    ...
    public static final ForgeConfigSpec.ConfigValue<String> PANEL_BG_COLOR;
    public static final ForgeConfigSpec.ConfigValue<String> ACCENT_COLOR;
    public static final ForgeConfigSpec.IntValue UI_CORNER_RADIUS;
