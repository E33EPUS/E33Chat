...
public class ServerConfigScreen extends Screen {
    ...
    public void render(DrawContext g, int mouseX, int mouseY, float partialTick) {
        //#if MC >= 12106
        g.drawTexture(RenderPipelines.GUI_TEXTURED, UiTextureManager.rl(UiElement.CONFIG_BG, ChatBubbleTheme.DARK),
            0, 0, 0f, 0f, width, height, 1, 1);
        //#else
        //#if MC >= 12102
        //$$ g.drawTexture(id -> net.minecraft.client.render.RenderLayer.getGuiTextured(id), UiTextureManager.rl(UiElement.CONFIG_BG, ChatBubbleTheme.DARK),
        //$$     0, 0, 0f, 0f, width, height, 1, 1);
        //#else
        ...
        // 分类与选项区分隔线
        //#if MC >= 12106
        g.drawTexture(RenderPipelines.GUI_TEXTURED, UiTextureManager.rl(UiElement.DIVIDER, ChatBubbleTheme.DARK),
            dividerX(), START_Y - 6, 0f, 0f, 1, viewBottom() - (START_Y - 6), 1, 1);
        //#else
        //#if MC >= 12102
        //$$ g.drawTexture(id -> net.minecraft.client.render.RenderLayer.getGuiTextured(id), UiTextureManager.rl(UiElement.DIVIDER, ChatBubbleTheme.DARK),
        //$$     dividerX(), START_Y - 6, 0f, 0f, 1, viewBottom() - (START_Y - 6), 1, 1);
        //#else
