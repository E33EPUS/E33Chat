 ...
 *
 * <p>Headless note: ModConfigSpec values throw until a config is loaded, so
 * this drives the documented test seam instead of the spec.
 */
class SidebarHidePatternTest {

    private static void setPatterns(List<String> patterns) {
        ChatBubbleConfig.sidebarHidePatternsSupplier = () -> patterns;
    }
